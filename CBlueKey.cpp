...
CBlueKey::CBlueKey(float x_w,float z_w):CItem()
{
x=x_w;
z=z_w;
il_akcji=0;
...
//   glColor3f(0,0,1);
   if (State!=E_PICKED_UP) CGraphics::DisplayInterpolatedMd2(6,tekst,current_frame,next_frame,interpol);
}


void CBlueKey::Update()
{
...
void CBlueKey::Pick_Up(CPlayer &Player) {
