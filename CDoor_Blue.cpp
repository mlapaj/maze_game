...
#include "CMap.h"
#include <iostream>
CDoor_Blue::CDoor_Blue(int xx, int zz,int s_type)
{
  State=E_CLOSED;
  type=s_type;
  x=xx+0.5;
...
void CDoor_Blue::Render()
{

   glEnable( GL_TEXTURE_2D );

   glBindTexture( GL_TEXTURE_2D, CGraphics::Texture(4));
...
bool  CDoor_Blue::Trigger(CPlayer &player)
{
