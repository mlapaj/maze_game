...
#include "CMap.h"
#include <iostream>
CDoor_Green::CDoor_Green(int xx, int zz,int s_type)
{
  State=E_CLOSED;
  type=s_type;
  x=xx+0.5;
...
void CDoor_Green::Render()
{

   glEnable( GL_TEXTURE_2D );

   glBindTexture( GL_TEXTURE_2D, CGraphics::Texture(6));
...
bool  CDoor_Green::Trigger(CPlayer &player)
{
