...
CGreenKey::CGreenKey(float x_w,float z_w):CItem()
{
x=x_w;
z=z_w;
il_akcji=0;
...
//   glColor3f(0,1,0);
   if (State!=E_PICKED_UP) CGraphics::DisplayInterpolatedMd2(7,tekst,current_frame,next_frame,interpol);
}


void CGreenKey::Update()
{
...
void CGreenKey::Pick_Up(CPlayer &Player) {
if ((State!=E_PICKED_UP)) {
                            State=E_PICKED_UP;
                            picked+=1;
                            Player.Set_Green_Key();
                            }
